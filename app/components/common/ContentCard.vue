...
<template>
  <motion.div
    :class="[
      `max-sm:w-[${props.maxWidth}px] flex w-full bg-white`,
      props.isVertical
        ? props.isReverse
          ? 'flex-col'
  ...
  >
    <div
      :class="[
        ...
        'border-white-alt2 border',
        props.isReverse
          ? props.isVertical
            ? 'border-b-[0px]'
            : 'border-l-[0px]'
          : props.isVertical
            ? 'border-t-[0px] md:border-t md:border-b-[0px]'
    ...
    <div class="shrink-0" :class="{ relative: props.isVertical }">
      <img
        ...
        :class="
          props.isVertical
            ? 'min-h-[175px] w-full min-w-[280px] object-cover md:min-h-[95px] md:min-w-[152px] lg:min-h-[175px] lg:min-w-[280px]'
            : `h-full w-full object-cover md:w-[220px] lg:w-[280px]`
        "
      />
    </div>
  </motion.div>
