...
<template>
  <motion.section class="mt-[10vh] w-full overflow-hidden" :style="{
      ...
      <div
        ...
        <div class="flex w-auto items-center justify-center sm:h-full">
          <div class="">
            ...
            <motion.div :variants="generalItemVariants">
              <p class="text-gray max-w-[642px] text-xl leading-[28px] font-normal md:text-sm md:leading-[26px] md:pr-10 lg:text-xl lg:leading-[28px]"
        ...
        <motion.div class="mt-8 aspect-[554/306] h-auto w-full shrink-0 sm:mt-0 md:w-[284px] xl:w-[554px]"
