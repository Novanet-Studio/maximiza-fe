...
<template>
  <div class="w-full">
    ...
    <input
      ...
      class="w-full px-3 py-2.5 text-black-alt font-normal bg-white border focus:outline-none focus:bg-white-alt/50 disabled:bg-white-alt2 disabled:text-gray transition-all duration-200 text-sm"
      :class="[
        errorMessage
    ...
    <div v-if="comment" class="mt-1 text-sm text-primary grid grid-cols-[20px_1fr] items-center gap-1">
