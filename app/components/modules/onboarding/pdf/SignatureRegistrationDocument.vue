    ...
    <div class="page-break-container">
      <header class="spreadsheet__header relative">
        ...
        <div class="mt-4 w-full text-right">
          ...
          <h1 class="text-primary text-lg font-bold uppercase">Ficha de Registro de Firma</h1>
      ...
      <div class="flex flex-col gap-4">
        <template v-for="(sig, index) in signatories" :key="index">
          <div class="signature-card border-primary break-inside-avoid border-2">
            <div class="grid grid-cols-[50px_1fr]">
              ...
              <div class="border-primary border-b py-1 text-center">
                ...
                <div class="text-sm font-bold text-gray-600">({{ sig.role }})</div>
              </div>
            </div>

            <div class="p-2">
              <div class="mb-1 grid grid-cols-[2fr_1fr] border-b border-black pb-1">
              ...
              <div class="grid min-h-[100px] grid-cols-2">
                <div class="flex flex-col items-center justify-end border-r border-black pr-2">
      ...
      <div class="mt-6 break-inside-avoid border-2 border-black p-2 text-center text-xs font-bold">
