<script setup lang="ts">
  ...
  const schema = yup.object({
    ...
    publicPhones: yup.string().required('Requerido').matches(PHONE_REGEX, 'Teléfono inválido'),
    publicPhones2: yup
      .string()
      .matches(PHONE_REGEX, {
...
<template>
  <form class="form-section" @submit.prevent>
    ...
    <h6 class="text-gray text-sm font-bold">Información de contacto alternativa (Opcional)</h6>
