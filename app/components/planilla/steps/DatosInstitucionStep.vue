<script setup lang="ts">
  ...
  const { handleSubmit, errors, defineField } = useForm({
    ...
    initialValues: {
      ...
      productionDate: wizard.state.value.formData.institutionData?.productionDate || '',
      inverstorNumber: wizard.state.value.formData.institutionData?.inverstorNumber || '',
...
<template>
  <form class="flex flex-col gap-6" @submit.prevent>
    ...
    <div>
      <FormTitle text="Datos de la institución del sector valores" class="mb-6" />
