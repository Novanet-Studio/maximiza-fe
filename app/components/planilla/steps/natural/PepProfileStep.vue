...
<template>
  <form class="flex flex-col gap-6" @submit.prevent>
    <div>
      ...
      <p class="bg-gray-50 mb-6 border-l-4 border-maximiza-verde1 p-2 text-sm text-maximiza-gris3">
        <strong>Definición PEP:</strong> Persona natural que desempeña o ha desempeñado funciones
