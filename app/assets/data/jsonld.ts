...
export const jsonld = {
    organization: {
        ...
        "publisher": {
            ...
            "description": "Contamos con 33 años de experiencia en el mercado bursátil venezolano, ofreciendo servicios de intermediación bursátil, finanzas corporativas e inversión.",
    ...
    services: {
        ...
        "description": "Gestionamos activos líquidos e instrumentos de financiamiento nacionales e internacionales.",
        "provider": {
            "@id": `${commonData.baseUrl}/#organization`
        }
    },
    ...
    about: {
        ...
        "description": "Aliados estratégicos en ingeniería financiera avanzada: gestión patrimonial, activos alternativos y financiamiento corporativo.",
        "mainEntity": {
            "@id": `${commonData.baseUrl}/#organization`
        }
    },
    contact: {
        ...
        "description": "Comuníquese con nosotros para mayor información de nuestros servicios financieros.",
        "mainEntity": {
            "@id": `${commonData.baseUrl}/#organization`
        }
    },
    ...
    register: {
        ...
        "description": "Apertura privada de cuenta de corretaje para inversores corporativos e individuales.",
        "publisher": {
            "@id": `${commonData.baseUrl}/#organization`
        },
        "potentialAction": {
