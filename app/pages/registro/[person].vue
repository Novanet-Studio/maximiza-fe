...
<template>
  <div
    v-if="personType == 'persona-natural' || personType == 'persona-juridica'"
    class="flex h-auto w-full flex-col"
  >
    <ModulesOnboardingHeader
      :title="labels[personType]!.title"
      :description="labels[personType]!.description"
      :banner="{
        src: labels[personType]!.banner,
      }"
    />

    <ModulesOnboardingRequierements
