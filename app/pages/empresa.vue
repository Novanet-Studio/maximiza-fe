  ...
  const institutionalValues = ref([
    {
      ...
      image: '/images/pages/empresa/items/maximiza-1.webp',
    },
    {
      label: 'Responsabilidad',
      description: 'patrimonial rigurosa',
      image: '/images/pages/empresa/items/maximiza-2.webp',
    },
    {
      label: 'Compromiso',
      description: 'analitico de excelencia',
      image: '/images/pages/empresa/items/maximiza-3.webp',
    },
    {
      label: 'Pensamiento',
      description: 'estrategico anticipado',
      image: '/images/pages/empresa/items/maximiza-4.webp',
    },
    {
      label: 'Transparencia',
      description: 'operativa absoluta',
      image: '/images/pages/empresa/items/maximiza-5.webp',
    },
  ])

  const alliesLogos = ref([
    {
      src: '/images/pages/empresa/allies/maximiza-logo-intesa-san-paolo.webp',
      alt: 'Logotipo Intesa Sanpaolo',
    },
    {
      src: '/images/pages/empresa/allies/maximiza-logotipo-vitral-advisory.webp',
...
<template>
  <div class="flex h-auto w-full flex-col">
    <CommonHero
      ...
      :image="{
        src: '/images/hero/maximiza-bolsa-de-valores-de-caracas.webp',
        alt: 'Hero Background',
      }"
      :pattern="{
        src: '/images/hero/maximiza-pattern-empresa.webp',
      }"
    />
    ...
    <CommonContentWithColumns
      ...
      background-image="/images/backgrounds/maximiza-mision-y-vision.webp"
      is-split-background
      auto-columns
      :columns="{
        left: 'md:w-[25%]',
    ...
    >
      <CommonContentCard
        ...
        :image="{
          url: '/images/pages/empresa/maximiza-mision-item.webp',
          alt: 'Misión',
        }"
        :styles="{
          title:
      ...
      <CommonContentCard
        ...
        :image="{
          url: '/images/pages/empresa/maximiza-vision-item.webp',
          alt: 'Visión',
        }"
        :styles="{
          title:
    ...
    <motion.section
      ...
      :style="{
        backgroundImage: `url(${'/images/backgrounds/maximiza-valores.webp'})`,
