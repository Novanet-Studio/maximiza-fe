        ...
        <div className="planilla__cuerpo">
          ...
          <div className="spreadsheet__section">
            ...
            <div className="spreadsheet__economic">
              ...
              <div className="spreadsheet__item text-center">
                Representante(s) legal(es) / Autorizados para realizar
          ...
          <div style={{ borderWidth: '2px' }} className="spreadsheet__section">
            ...
            <p className="spreadsheet__contract">
              Aceptación contrato de cuenta de corretaje bursátilexpresamente
              por parte del inversor con la firma delque presente documento,
              ﬁnancieras el cliente expresamente Con la ﬁrmadel del presente
              documento , el cliente conviene y acepta las operaciones y
              bursátiles celebra- conviene acepta que las y bursátiles
              celebradas entre maximiza y elbursátil, cliente sedel regirán
              contrato de cuenta corretaje das entrey maximiza y eloperaciones
              cliente sefinancieras regirán por el contrato de cuenta corretaje
              cualpor el elpresente anexo forma parte bursátil, del ycual el
              presente anexo forma parte integrante, y pública cual fue
              autenticado por ante lachacao Notaría del Pública sexta del
              Municipio deldel estado integrante, el cual fue autenticado por
              ante la notaria sexta del municipio estado miranda, el 26Chacao de
              enero 2007, Miranda, 26tomo de Enero del los 2007, bajode el N°56,
              tomo 10, de los libros deesa autenticación llevados porel esa
              notaría, así mismo, el cliente haber bajo el n°el56, 10, de libros
              autenticacion llevados por notaria, asi mismo, cliente declara
              haber leido ydeclara comprendido leído y comprendido las
              operaciones objeto de los contratos que integran la cuenta de
              corretaje bursátil. De conformidad con lo establecido en las las
              operaciones objeto de los contratos que integran la cuenta de
              corretaje bursátil. De conformidad con lo establecido en el
              articulo normas relativas a la administración y fiscalización de
              los riesgos relacionados con los delitos de legitimación de los
              capitales, financiamiento al n°41 de la providencia n° 074
              publicada en gaceta oﬁcial n° 41,788 de fecha 26 de junio de 2019,
              emanada por la superintendecia terrorismo, financiamiento de la
              proliferación de armas de destrucción masiva y otros ilícitos,
              aplicables a los sujetos regulados por la nacional de valores, el
              (los) inversor (es) declara (n) bajo fe de juramento que los
              dineros, capitales y haberes, valores o titulos utilizados
              Superintendencia Nacional de Valores, por lo que el (los)
              inversor(es) declara(n) bajo fe de juramento que los dineros,
              capitales y haberes, valores en las operaciones, no guardan
              relacion con actividades provenientes del delito de legitimacion
              de capitales u otros delitos previstos y o títulos utilizados en
              las operaciones, no guardan relación con actividades provenientes
              del delito de legitimación de capitales u otros delitos
              sancionados en la ley orgánica juramento que los dineros,
              capitales y haberes, valores o titulos utilizados en las
              operaciones, no previstos y sancionados en la ley orgánica contra
              la delincuencia organizada y financiamiento al terrorismo. Así
              mismo, el inversor expresamente guardan relacion con actividades
              provenientes del delito de legitimacion de capitales u otros
              delitos previstos y sancionados en la ley declara que la
              ...
              suficientemente a Maximiza Casa de Bolsa, C.A., para quede
              verifique datos aportados y que han vertidos en estayplanilla,
              señalados en la en esta planilla,N°209 en cumplimiento a lo
              establecido en laesta normativa providencia y las demás
              disposiciones que tutelan materia.
            </p>
          </div>
          ...
          <div style={{ borderWidth: '2px' }} className="spreadsheet__section">
            ...
            <p className="spreadsheet__contract">
              ...
              1) Que los datos suministrados son verdaderos y autoriza a la institución del sector valores a verificar dicha información. <br /> <br />
              2) Que los fondos utilizados tienen origen y destino lícitos, según lo previsto y sancionado en el ordenamiento jurídico vigente en la República Bolivariana de Venezuela. <br /> <br />
              3) Que notificará de inmediato cuando se produzcan cambios en los datos personales y/o en movimiento de fondos reportados. <br />
            </p>
          </div>
          ...
          <div style={{ borderWidth: '2px' }} className="spreadsheet__section">
            ...
            <ol className="spreadsheet__list">
              <li>Copia del Registro de información Fiscal (R.I.F) de la empresa.</li>
              <li>Copa de la cédula de identidad y del R.I.F del (los) representante legal (es) de la empresa.</li>
              <li>Copa del Documento constitutivo y las modificaciones estatutarias.</li>
          ...
          <div className="simple-text">El Ejecutivo de Cuentas declara haberse entrevistado con el cliente, Quien ﬁrmó esta planilla en su presencia</div>
          ...
          <span className="copy">Maximiza Casa de Bolsa. R.I.F. Nro. J-30025492-5</span>
        </div>
      </div>
    </section>
  );
